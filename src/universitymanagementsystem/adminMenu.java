...
public class adminMenu extends javax.swing.JFrame {
    ...
    public adminMenu(String username,String name, String telephone, String id){
        this.name = name;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        adminEditInfo aeiObject = new adminEditInfo(name, username, id, telephone);
        aeiObject.setVisible(true);
