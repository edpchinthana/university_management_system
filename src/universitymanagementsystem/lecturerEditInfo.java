 ...
 */
public class lecturerEditInfo extends javax.swing.JFrame {

    /**
     * Creates new form lecturerEditInfo
     */
    String username;
    String name;
    String id;
    String telephone;
    String password;
    public lecturerEditInfo() {
        initComponents();
    }
    
    public lecturerEditInfo(String username, String name, String telephone){
        this.name = name;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lecturerEditInfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lecturerEditInfo().setVisible(true);
            }
        });
    }
